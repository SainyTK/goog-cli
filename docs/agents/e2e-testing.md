...
- **Reads are unrestricted.** `mail list/search/read`, `drive ls/list/download`, `docs list/map/search-text/get-content/get`, `sheets list/get/batch-get` may target any existing file, message, or thread in the account.
