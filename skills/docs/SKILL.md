...
- When reproducing a source document, `goog docs compare SOURCE TARGET --fail-on-difference` has checked component inventory, named and page styles, and mapped content properties after generated IDs are removed.
