...
- Retain the final JSON acceptance record because it identifies the resolved account, when acceptance occurred, and the exact source and copied revisions that passed fidelity verification.
