...
- Retain the final JSON acceptance record because it identifies when acceptance occurred and the exact source and copied revisions that passed fidelity verification.
