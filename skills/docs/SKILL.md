...
- Retain the final JSON acceptance record because it identifies both document IDs, titles, and edit URLs, the resolved account, running executable SHA-256, when acceptance occurred, and the exact source and copied revisions that passed fidelity verification.
