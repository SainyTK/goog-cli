...
- The generated executable-pinned, revision-guarded replay command has been retained with fidelity evidence so a different binary or later document edit cannot be mistaken for the accepted state.
