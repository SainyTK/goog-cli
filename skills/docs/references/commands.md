...
The final JSON acceptance record identifies both document IDs and edit URLs, the resolved account, goog CLI version, execution OS and architecture, running executable path and SHA-256, when acceptance occurred, and the exact source and copied revisions that passed verification.
