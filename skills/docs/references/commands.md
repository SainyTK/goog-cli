...
The final JSON acceptance record identifies the resolved account, when acceptance occurred, and the exact source and copied revisions that passed verification.
