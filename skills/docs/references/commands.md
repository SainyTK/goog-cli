...
Each report identifies the source and target by title, document ID, edit URL, and the revision ID fetched for the comparison.
Keep those revision IDs with acceptance evidence so a later document edit cannot be mistaken for the tested input.
