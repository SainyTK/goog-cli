...
Notes:
  ...
  Replay commands pin the recorded goog executable path and the resolved account shared by both documents, or use --source-account and --target-account when the accounts differ.
