...
Notes:
  ...
  Verified acceptance records identify the resolved account, goog CLI version, running executable path and SHA-256, acceptance time, and the exact source and copied revisions that passed comparison.
