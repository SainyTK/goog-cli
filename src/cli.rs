...
Notes:
  ...
  Reports include a revision-guarded replay command, the UTC comparison time, goog CLI version, executable path and SHA-256, comparison settings, and identify both live documents by title, ID, edit URL, compared revision ID, and the account that accessed each document.
