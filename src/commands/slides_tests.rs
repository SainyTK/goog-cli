...
#[tokio::test]
async fn run_table_delete_row_sends_delete_table_row_request() {
    let server = MockServer::start().await;
    Mock::given(method("POST"))
        .and(path(
            "/slides/v1/presentations/presentation-123:batchUpdate",
    ...
    run_table_delete_row_unified_to(
        &test_config(),
        &store,
        None,
...
#[tokio::test]
async fn run_table_insert_columns_sends_insert_table_columns_request() {
    let server = MockServer::start().await;
    Mock::given(method("POST"))
        .and(path(
            "/slides/v1/presentations/presentation-123:batchUpdate",
    ...
    run_table_insert_columns_unified_to(
        &test_config(),
        &store,
        None,
...
#[test]
fn build_table_insert_columns_rejects_api_limit_overflow() {
    let err = build_table_insert_columns_batch_update(TableInsertColumnsRequest {
        presentation_id: "presentation-123".into(),
        table_id: "table-1".into(),
        reference_row: 0,
        reference_column: 0,
...
#[tokio::test]
async fn run_table_merge_cells_sends_merge_table_cells_request() {
    let server = MockServer::start().await;
    Mock::given(method("POST"))
        .and(path(
            "/slides/v1/presentations/presentation-123:batchUpdate",
    ...
    run_table_merge_cells_unified_to(
        &test_config(),
        &store,
        None,
...
#[test]
fn build_table_merge_cells_rejects_zero_span() {
    let err = build_table_merge_cells_batch_update(TableMergeCellsRequest {
        presentation_id: "presentation-123".into(),
        table_id: "table-1".into(),
        start_row: 0,
        start_column: 0,
    ...
    assert!(err.to_string().contains("spans must be greater than zero"));
}

#[tokio::test]
async fn run_table_unmerge_cells_sends_unmerge_table_cells_request() {
    let server = MockServer::start().await;
    Mock::given(method("POST"))
        .and(path(
            "/slides/v1/presentations/presentation-123:batchUpdate",
    ...
    run_table_unmerge_cells_unified_to(
        &test_config(),
        &store,
        None,
...
#[test]
fn build_table_unmerge_cells_rejects_zero_span() {
    let err = build_table_unmerge_cells_batch_update(TableUnmergeCellsRequest {
        presentation_id: "presentation-123".into(),
        table_id: "table-1".into(),
        start_row: 0,
        start_column: 0,
