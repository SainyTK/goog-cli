...
use crate::docs::map::{
    search_document_text, DocumentLocation, DocumentMap, DocumentMapEntry, DocumentMapEntryKind,
    DocumentRange, DocumentTextBlock,
};
...
#[derive(Debug, Clone, PartialEq, Eq)]
pub(crate) enum InsertTextSelector {
    Index(i64),
    Entry(usize),
    PageLine { page: usize, line: usize },
    AfterHeading(String),
...
pub(crate) fn resolve_content_entry<'a>(
